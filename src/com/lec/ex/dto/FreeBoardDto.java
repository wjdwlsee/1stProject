...
public class FreeBoardDto {
	...
	private String fip;
	public FreeBoardDto() {}
	public FreeBoardDto(int fid, String mid, String mname, String ftitle, String fcontent, String ffileName,
	...
	public String toString() {
		return "FreeBoardDto [fid=" + fid + ", mid=" + mid + ", mname=" + mname + ", ftitle=" + ftitle + ", fcontent="
