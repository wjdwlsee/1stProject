...
select * from freeboard where ftitle = '수영장';
--FREEBOARD
...
INSERT INTO FREEBOARD (FID, MID, FTITLE, FCONTENT, FFILENAME, FGROUP, FSTEP, FINDENT, FIP)
  VALUES (FREEBOARD_SEQ.NEXTVAL, 'jang','주말나들이','등산은 아이들과', 'hiking.jpg', 
    FREEBOARD_SEQ.CURRVAL, 0,0, '192.168.0.31');
INSERT INTO FREEBOARD (FID, MID, FTITLE, FCONTENT, FFILENAME, FGROUP, FSTEP, FINDENT, FIP)
  VALUES (FREEBOARD_SEQ.NEXTVAL, 'kang','단풍구경','설악산으로 단풍구경 다녀왔어요', 'sulak.jpg', 
    FREEBOARD_SEQ.CURRVAL, 0,0, '192.168.0.31');
INSERT INTO FREEBOARD (FID, MID, FTITLE, FCONTENT, FFILENAME, FGROUP, FSTEP, FINDENT, FIP)
  VALUES (FREEBOARD_SEQ.NEXTVAL, 'kim','제주도 ','해산물먹으러 다녀왔어요', 'seafood.jpg', 
    FREEBOARD_SEQ.CURRVAL, 0,0, '192.168.0.31');
INSERT INTO FREEBOARD (FID, MID, FTITLE, FCONTENT, FFILENAME, FGROUP, FSTEP, FINDENT, FIP)
  VALUES (FREEBOARD_SEQ.NEXTVAL, 'lee','성수미술관','미술관은 언제나 즐거워', 'artcenter.jpg', 
    FREEBOARD_SEQ.CURRVAL, 0,0, '192.168.0.31');
