...
<body>
	<div id="content_form">
		<table>
			<caption>${info.iid }번글 상세보기</caption>
			<tr><td>제목</td>	 <td>${info.ititle }</td> 
			</tr>
				<tr>
							<td>
					<c:if test="${not empty info.ifilename }">
						<a href="${conPath }/infoFileUp/${info.ifilename}" target="_blank">
							<img src="${conPath }/infoFileUp/${info.ifilename}"	alt="${info.iid }사진" width="200" >
						</a>
					</c:if>
			...
			<td>
					<c:if test="${not empty info.ifilename2 }">
						<a href="${conPath }/infoFileUp/${info.ifilename2}" target="_blank">
							<img src="${conPath }/infoFileUp/${info.ifilename2}"	alt="${info.iid }사진" width="200" >
						</a>
					</c:if>
